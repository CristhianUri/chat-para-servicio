                            ...
                            <div class="container">
                                <div class="d-flex justify-content-center ">
                                    ...
                                    <div class="col-lg-6 col-md-3">
                                        ...
                                        <form id="frm_nuevares" method="POST" action="../../infochat/contenidochat/Actualizarpre.php">
                                            ...
                                            <div class="mb-3 text-center">
                                                ...
                                                <input type="text" class="form-control border-dark texarea "
                                                    ...
                                                    value="<?php echo $resultado['queries'] ?>"
                                                    placeholder="<?php echo $resultado['queries'] ?>">
                                            </div>
                                            <div class="mb-3 text-center">
                                                <label for="response2" class="form-label">Estas son las respuestas 
                                                    registradas en el chat <br>
                                                    <strong>Nota:</strong>
                                                        Si cambias lo que se encuentra escrito aqui la respuesta del chat cambiara
                                                </label>
                                                <input class="form-control border-dark texarea" id="responses"
                                                    name="responses" rows="3"
                                                    value="<?php echo $resultado['responses'] ?>"
                                                    placeholder="<?php echo $resultado['responses'] ?>"></input>
                                            </div>
                                            <div class="mb-3">
